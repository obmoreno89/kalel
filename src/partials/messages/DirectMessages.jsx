  ...
  return (
    <div className='mt-1'>
      ...
      <ul className='mb-6bg-secondary px-2'>
        <li className='-mx-2 hover:bg-secondary px-2 py-1 hover:border-l-2 hover:border-primary'>
          <button
            ...
            <div className='flex justify-between items-center'>
              ...
              <div className=' w-full'>
                ...
                <div className='text-left'>
                  <p className='text-black font-bold text-medium'>Jhon Doe</p>
                  <div className='flex'>
                    <img src={icons.arrowInter} alt='icono' />
                    <p className='text-xs'>Hola Jhon, gracias por esperar...</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          >
            <div className='flex justify-between items-center'>
              ...
              <div className=' w-full'>
                ...
                <div className='text-left'>
                  <p className='text-black font-bold text-medium'>
                    Kate Winslet
                  </p>
                  <div className='flex'>
                    <img src={icons.arrowSent} alt='icono' />
                    <p className='text-xs'>Gracias a ustedes por la ayuda</p>
                  </div>
                </div>
              </div>
            </div>
